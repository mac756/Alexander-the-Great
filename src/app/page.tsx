...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-stone-100 to-stone-50">
      ...
      {/* Hero Section */}
      <header className="py-20 px-6 text-center greek-pattern">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold text-stone-900 mb-6 font-[family-name:var(--font-playfair)]">
            Alexander the Great
          ...
          <p className="text-xl text-stone-600 max-w-2xl mx-auto leading-relaxed">
            ...
            Discover the truth about his dependency on his father Philip II and why 
            his &quot;greatness&quot; may be more inherited than earned.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Link href="/timeline" className="group">
            <div className="bg-white rounded-lg shadow-lg p-8 border-t-4 border-amber-600 hover:shadow-xl transition-all h-full">
              <h2 className="text-2xl font-bold text-stone-800 mb-3 font-[family-name:var(--font-playfair)]">Interactive Timeline</h2>
          ...
          <Link href="/philip-factor" className="group">
            <div className="bg-white rounded-lg shadow-lg p-8 border-t-4 border-red-700 hover:shadow-xl transition-all h-full">
              <h2 className="text-2xl font-bold text-stone-800 mb-3 font-[family-name:var(--font-playfair)]">The Philip Factor</h2>
          ...
          <Link href="/comparison" className="group">
            <div className="bg-white rounded-lg shadow-lg p-8 border-t-4 border-stone-600 hover:shadow-xl transition-all h-full">
              <h2 className="text-2xl font-bold text-stone-800 mb-3 font-[family-name:var(--font-playfair)]">Alexander vs Napoleon</h2>
          ...
          <Link href="/sources" className="group">
            <div className="bg-white rounded-lg shadow-lg p-8 border-t-4 border-stone-500 hover:shadow-xl transition-all h-full">
              <h2 className="text-2xl font-bold text-stone-800 mb-3 font-[family-name:var(--font-playfair)]">Sources</h2>
              <p className="text-stone-600">Academic citations and primary sources for further reading.</p>
            </div>
          </Link>
        </div>
        ...
        <section className="mt-16 bg-stone-800 text-stone-100 rounded-lg p-8 md:p-12">
          <h2 className="text-3xl font-bold mb-6 text-center font-[family-name:var(--font-playfair)]">The Thesis</h2>
          <div className="max-w-3xl mx-auto text-lg leading-relaxed space-y-4">
            ...
            <p>
              This educational resource examines the evidence that challenges Alexander&apos;s traditional 
              narrative, comparing his inherited empire to those built from scratch by leaders like 
              Napoleon Bonaparte.
            </p>
          </div>
        </section>
